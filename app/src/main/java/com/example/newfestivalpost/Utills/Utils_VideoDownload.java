...
public class Utils_VideoDownload {
    ...
    public Utils_VideoDownload(Context context, String url, int isShare, int tag) {
       ...
       // fileName = URLUtil.guessFileName(url, null, "video/*");
        ...
        String folder = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" + "Banner Maker";
        ...
        String location = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" +"Banner Maker" + "/" + fileName;
    ...
    private class DownloadTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... sUrl) {
            ...
            try {
                ...
                location = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" + "Banner Maker" + "/" + fileName;
