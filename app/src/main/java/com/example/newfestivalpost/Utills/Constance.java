...
public class Constance {
  ...
  //  public static ArrayList<ModelHomeChild> viewAllDataList=new ArrayList<>();
    ...
    public static String FolderNameSave ="/Banner Maker";
   // public static File FileSaveDirectory = Environment.getExternalStoragePublicDirectory("/"+FolderNameSave+ "/");
    public static File FileSaveDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" +"Banner Maker");
    public static File FileSaveVideoDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" +"Banner Maker");
    public static String FolderNameShare ="/Banner Maker";
    ...
    public static String moreAppurl = "https://play.google.com/store/apps/dev?id=4873742009842360386";
