...
public class DVideoListFragment extends Fragment {
    ...
    private void getAllFiles() {
        ...
        // Toast.makeText(context,""+Constance.FileSaveDirectory,Toast.LENGTH_LONG).show();
        //Toast.makeText(context,"fileArrayList 1 :"+fileArrayList.size(),Toast.LENGTH_LONG).show();
        ...
        if (!Constance.FileSaveVideoDirectory.exists()) {
            ...
            // Toast.makeText(context,"fileArrayList 1 :"+files.length,Toast.LENGTH_LONG).show();
            //  Log.d("check_file", "files :" + files.length);
            if (files != null) {
                for (File file : files) {
